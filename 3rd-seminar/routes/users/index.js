...
const encPwd = crypto.pbkdf2Sync(password, salt, 100000, 64, 'sha512').toString('base64');
...
const inPwd = crypto.pbkdf2Sync(password, user.salt, 100000, 64, 'sha512').toString('base64');
if(inPwd !== user.password) {
